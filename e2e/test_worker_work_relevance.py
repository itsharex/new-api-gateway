...
def setup(dsn: str) -> None:
    ...
    with psycopg.connect(dsn) as conn:
        ...
        conn.execute(
            ...
            (
                ...
                "file:///raw/e2e/trace_work/request_body.bin", "file:///raw/e2e/trace_work/response_body.bin",
    ...
    job = {
        ...
        "employee_no": "E10001",
        "username": "E10001",
        "request_raw_ref": "file:///raw/e2e/trace_work/request_body.bin",
        "response_raw_ref": "file:///raw/e2e/trace_work/response_body.bin",
