...
def test_compute_trace_level_baselines_returns_two_rows_per_fingerprint():
    rows = [
        {"fingerprint_key": "fp_a", "p95_total": 8000.0, "p95_completion": 3000.0},
    ]
...
def test_compute_trace_level_baselines_returns_multiple_fingerprints():
    rows = [
        {"fingerprint_key": "fp_a", "p95_total": 100.0, "p95_completion": 50.0},
        {"fingerprint_key": "fp_b", "p95_total": 200.0, "p95_completion": 80.0},
    ]

    result = compute_trace_level_baselines(rows)

    assert len(result) == 4
    assert result[0].metric_type == "trace_tokens_p95"
    ...
    assert result[2].metric_type == "trace_tokens_p95"
...
def test_upsert_baselines_inserts_all_rows_and_commits():
    ...
    baselines = [
        ...
        BaselineRow("fp_a", "trace_tokens_p95", 12000.0, {}),
    ]
    ...
    assert params1[1] == "trace_tokens_p95"
